...
<body>
    ...
    <div class="center">
        <div class="slider_box">
            <div id="slider">
                <img src="img/granite/g11.jpg" alt="">
                <img src="img/granite/g12.jpg" alt="">
                <img src="img/granite/g13.jpg" alt="">
                <img src="img/granite/g14.jpg" alt="">
            </div>
       ...
       <br>
        <h1 class="color-h1">BLACK GALAXY GOLDEN STAR GRANITE</h1> 
       <br>
        <h2 class="color-h2">
            <ul id="first-ul">
                <lh>FEATURES</lh>   <br>
            ...
            <ul id="first-ul">  
                <lh>SPECIFICATIONS</lh> <br>
                    ...
                    <li>Bharat Granite</li>
            </ul>
        </h2>
       <br>
        <h3 class="color-h3"><span class="color-span1"><img src="rupee_img.png" alt="" id="rupee">200.00</span>/Per Square Feet</h3>
       <br>
        <form name="f1" action="g-color1.php" method="post">
            ...
            <input type="text" name="pname"style="display:none" size=5px value="BLACK GALAXY GOLDEN STAR GRANITE">
