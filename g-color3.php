...
<body>
    ...
    <div class="center">
        <div class="slider_box">
            <div id="slider">
                <img src="img/granite/g31.jpg" alt="">
                <img src="img/granite/g32.jpg" alt="">
                <img src="img/granite/g33.jpg" alt="">
                <img src="img/granite/g34.jpg" alt="">
            </div>
       ...
       <br>
        <h1 class="color-h1">STATUARIO EXTRA WHITE GRANITE</h1> 
       <br>
        <h2 class="color-h2">
            <ul id="first-ul">
                <lh>FEATURES</lh>   <br>
                    <li>Smooth Finish </li>
                    <li>Striking Color and Smooth Surface</li>
       ...
       <br>
        <h3 class="color-h3"><span class="color-span1"><img src="rupee_img.png" alt="" id="rupee">250.00</span>/Square Feet</h3>
       <br>
       <form name="f1" action="g-color3.php" method="post">
        ...
        <input type="text" name="pname"style="display:none" size=5px value="STATUARIO EXTRA WHITE GRANITE">
