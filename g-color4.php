...
<body>
    ...
    <div class="center">
        <div class="slider_box">
            <div id="slider">
                <img src="img/granite/g41.jpg" alt="">
                <img src="img/granite/g42.jpg" alt="">
                <img src="img/granite/g43.jpg" alt="">
                <img src="img/granite/g44.jpg" alt="">
            </div>
       ...
       <br>
        <h1 class="color-h1">ROSY PINK GRANITE</h1> 
       <br>
        <h2 class="color-h2">
            <ul id="first-ul">
                <lh>FEATURES</lh>   <br>
                    <li>Available In Slab Form</li>
                    <li>Best Uses Counter Tops</li>
                    <li>Used for Flooring</li>
            </ul>
            <ul id="first-ul">  
                <lh>SPECIFICATIONS</lh> <br>
                    <li>Slab Thickness : 15 mm - 18 mm</li>
                    <li>High Gloss Polishe </li>
                    <li>Easy Maintenance</li>
            </ul>
        </h2>
       <br>
        <h3 class="color-h3"><span class="color-span1"><img src="rupee_img.png" alt="" id="rupee">70.00</span>/Square Feet</h3>
       <br>
       <form name="f1" action="g-color4.php" method="post">
        ...
        <input type="text" name="pname"style="display:none" size=5px value="ROSY PINK GRANITE">
        <input type="text" name="rname"style="display:none" size=5px value="250">
