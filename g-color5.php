...
<body>
    ...
    <div class="center">
       ...
       <br>
       <form name="f1" action="g-color5.php" method="post">
        ...
        <input type="text" name="pname"style="display:none" size=5px value="RUBY RED GRANITE">
        <input type="text" name="rname"style="display:none" size=5px value="125">
