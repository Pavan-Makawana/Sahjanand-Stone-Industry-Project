...
<body>
    ...
    <div class="center">
        <div class="slider_box">
            <div id="slider">
                <img src="img/mable/m11.jpg" alt="">
                <img src="img/mable/m12.jpg" alt="">
                <img src="img/mable/m13.jpg" alt="">
                <img src="img/mable/m14.jpg" alt="">
            </div>
       ...
       <br>
        <h1 class="color-h1">SANGEMARMAR WHITE MARBLE</h1> 
       <br>
        <h2 class="color-h2">
            <ul id="first-ul">
                <lh>FEATURES</lh>   <br>
                    <li>Appliring For Flooring , etc</li>
                    <li>Made In India</li>
                    <li>The House Looks More Beautifull</li>
            </ul>
            <ul id="first-ul">  
                <lh>SPECIFICATIONS</lh> <br>
                    <li> Thickness : 13 mm - 15 mm</li>
                    <li>Smooth And Polished </li>
            </ul>
        </h2>
       <br>
        <h3 class="color-h3"><span class="color-span1"><img src="rupee_img.png" alt="" id="rupee">300.00</span>/ Square Feet</h3>
       <br>
       <form name="f1" action="m-color1.php" method="post">
        ...
        <input type="text" name="pname"style="display:none" size=5px value="SANGEMARMAR WHITE MARBLE">
        <input type="text" name="rname"style="display:none" size=5px value="300">
