...
<body>
    ...
    <div class="center">
        <div class="slider_box">
            <div id="slider">
                <img src="img/mable/m41.jpeg" alt="">
                <img src="img/mable/m42.jpeg" alt="">
                <img src="img/mable/m43.jpeg" alt="">
                <img src="img/mable/m44.jpeg" alt="">
            </div>
       ...
       <br>
        <h1 class="color-h1">CARROT RED MARBLE SLAB</h1> 
       <br>
        <h2 class="color-h2">
            <ul id="first-ul">
                <lh>FEATURES</lh>   <br>
                    <li>Smooth,Polished, And Honed Surface </li>
                    <li>Natural Stone</li>
       ...
       <br>
        <h3 class="color-h3"><span class="color-span1"><img src="rupee_img.png" alt="" id="rupee">50.00</span>/ Square Feet</h3>
       <br>
       <form name="f1" action="m-color4.php" method="post">
        ...
        <input type="text" name="pname"style="display:none" size=5px value="CARROT RED MARBLE SLAB">
        <input type="text" name="rname"style="display:none" size=5px value="50">
