...
<body>
    ...
    <div class="center">
        <div class="slider_box">
            <div id="slider">
                <img src="img/mable/m51.jpg" alt="">
                <img src="img/mable/m52.jpg" alt="">
                <img src="img/mable/m53.jpg" alt="">
                <img src="img/mable/m54.jpg" alt="">
            </div>
       ...
       <br>
        <h1 class="color-h1">POLISHED BEIGE ITALIAN MARBLE</h1> 
       <br>
        <h2 class="color-h2">
            <ul id="first-ul">
                <lh>FEATURES</lh>   <br>
                    <li>Low Water Absorption Capacity</li>
       ...
       <br>
        <h3 class="color-h3"><span class="color-span1"><img src="rupee_img.png" alt="" id="rupee">180.00</span>/ Square Feet</h3>
       <br>
       <form name="f1" action="m-color5.php" method="post">
        ...
        <input type="text" name="pname"style="display:none" size=5px value="POLISHED BEIGE ITALIAN MARBLE">
        <input type="text" name="rname"style="display:none" size=5px value="180">
