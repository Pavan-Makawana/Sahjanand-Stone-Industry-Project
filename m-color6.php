...
<body>
    ...
    <div class="center">
        <div class="slider_box">
            <div id="slider">
                <img src="img/mable/m61.jpg" alt="">
                <img src="img/mable/m62.jpg" alt="">
                <img src="img/mable/m63.jpg" alt="">
                <img src="img/mable/m64.jpg" alt="">
            </div>
       ...
       <br>
        <h1 class="color-h1">POLISHED GREEN MARBLE SLAB</h1> 
       <br>
        <h2 class="color-h2">
            <ul id="first-ul">
                <lh>FEATURES</lh>   <br>
                    <li>Natural Color And Attractive Look</li>
                    <li>Long - Lasting</li>
                    <li>Best For House Flooring</li>
            </ul>
            <ul id="first-ul">  
       ...
       <br>
        <h3 class="color-h3"><span class="color-span1"><img src="rupee_img.png" alt="" id="rupee">75.00</span>/ Square Feet</h3>
       <br>
       <form name="f1" action="m-color6.php" method="post">
        ...
        <input type="text" name="pname"style="display:none" size=5px value="POLISHED GREEN MARBLE SLAB">
        <input type="text" name="rname"style="display:none" size=5px value="75">
